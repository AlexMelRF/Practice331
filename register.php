...
if(isset($_POST["register"])) {
    ...
    if(is_array($user_data) && count($user_data) > 0)
        ...
        if($user_object->save_data()) {
            ...
            $mail->Body = '
            <p>Thank you for registering for Chat</p>
                <p>This is a verification email, please click the link below to verify your email address.</p>
                <p><a href="http://localhost/Practice331_temp/verify.php?code='.$user_object->getUserVerificationCode().'">Click to verify</a></p>
                <p>Thank you</p>
            ';
            $mail->send();
            $success_message = 'Verification email sent to ' . $user_object->getUserEmail() . ', login first verify your email'.$user_object->getUserVerificationCode();
        }
        else
...
<body>
    <div class="containter">
        <br />
        <br />
        <h1 class="text-center">Chat - Email Verification</h1>
